...
class JavaFactory {
  def context(selfId: Int, exports: util.HashMap[Int,ExportImpl], lsens: util.HashMap[String,Object],
              nbsens: util.HashMap[String,util.HashMap[Int,Object]])
    = factory.context(selfId, exports.asScala.toMap, lsens.asScala.toMap, nbsens.asScala.toMap.mapValues(_.asScala.toMap))
}